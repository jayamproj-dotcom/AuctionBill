...
import {
  mainVendorForgotPassword as forgotPassword,
  mainVendorResetPassword as resetPassword,
      ...
      <div className="saas-login-card fade-in">
        ...
        {step === 1 ? (
          <form onSubmit={handleSendOTP} className="saas-login-form">
            ...
            <button
              type="submit"
              className="saas-btn btn-primary saas-login-btn"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
                  <Loader className="saas-spinner" size={18} /> Sending...
                </>
              ) : (
                "Send OTP"
              )}
          ...
          <form onSubmit={handleResetPassword} className="saas-login-form">
            ...
            >
              {isLoading ? (
                <>
                  <Loader className="saas-spinner" size={18} /> Resetting...
                </>
              ) : (
                "Reset Password"
              )}
